...
const Project = ({name, description, set}) => {
  return(
    <div className="bg-gray-100 rounded-2xl shadow-lg w-56 h-24 border-2 border-blue-200 transition-all transform hover:scale-105 p-2 overflow-ellipsis cursor-default" >
