        ...
        <div className="md:flex items-center justify-between py-2 px-8 md:px-12">
            <div className="flex justify-between items-center">
               <div className="text-2xl font-bold text-gray-800 md:text-3xl cursor-pointer">
                    <span onClick={props.set}>Website Title</span>
               </div>
            ...
            <div className="flex flex-col md:flex-row hidden md:block -mx-2">
                <a href="" className="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2 cursor-pointer">Contact</a>
            </div>
        </div>
    </nav>
    </div>
